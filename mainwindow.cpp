    ...
    , ui(new Ui::MainWindow)
{
    ...
    // Use the promoted VTK widget from Qt Designer.
    // Do NOT create a second QVTKOpenGLNativeWidget manually.
...
{
    // Button 1 opens item options.
    on_actionItem_Options_triggered();
}

void MainWindow::on_Button2_clicked()
{
    // Button 2 removes selected item from the render view.
